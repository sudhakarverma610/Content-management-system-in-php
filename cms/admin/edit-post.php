    ...
    <div class="container-fluid body-section">
      ...
      require_once('inc/sidebar.php');
        ?>
          ...
          <div class="col-md-9">
             <h1 class="animated rubberBand"><i class="fa fa-pencil"></i>Edit post<small>&nbsp;Edit Post Details</small></h1><hr>
             <ol class="breadcrumb">
             ...
             if (isset($_POST['update'])) {
               ...
               if (empty($up_title) or empty($up_post_data) or empty($up_tags)) {
                ...
                $update_query="UPDATE posts SET title='$up_title',image='$up_image',catagory='$up_catagory',tags='$up_tags',post_data='$up_post_data',status='$up_status' where id=$edit_id";
